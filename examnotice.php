  ...
  <div class="row content">
    ...
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked" id="nav">
        ...
        <li class="active"><a href="examnotice.php">Exam Notice</a></li>
          ...
          <div class="col-sm-9">
                ...
                <div class="col-md-8" id="form-login">
                    <form class="well" action="" method="post" name="upload_excel" enctype="multipart/form-data">
                       ...
                       <h3><a href="pdf_server.php?file=syllabus/sem1">SEM I & II</a><br></h3>
                       
        <h3><a href="pdf_server.php?file=syllabus/syllabus/sem1">SEM III & IV</a><br></h3>      
          <h3><a href="pdf_server.php?file=syllabus/syllabus/sem1">SEM V & VI</a><br></h3>
          <h3><a href="pdf_server.php?file=syllabus/sem1">SEM VI & VII</a><br></h3>
