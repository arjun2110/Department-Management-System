...
?>
 ...
 <?php
         ...
         $sql = "SELECT Name FROM staff where DEPARTMENT= '".$_SESSION['Dept']."'";
                     $result = mysqli_query($conn, $sql);
?>
           <select name ="Staff_Select" class="form-control" style="width:350px"required  >
...
?>
            <select name ="sem" required id="sem" class="form-control" style="width:350px" >
  ...
  <div class="controls form-group">
            ...
            <select name="Subname_Select" required="" id="subname" class="form-control" style="width:350px">
       ...
       <div class="controls form-group">
            ...
            <select name="Subcode_Select" required="" id="subcode"  class="form-control" style="width:350px" >
