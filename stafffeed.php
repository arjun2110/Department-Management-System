...
if(isset($_SESSION["username"]))  {
 $tag= "<center>Hello"." ".$_SESSION["username"]." "."</center>";
} else {
...
16cdPddA6VdVInumRGo6IbivbERE8p7CQR3HzTBuELA="   crossorigin="anonymous">  
   ...
   <form action="stafffeed.php" method="post">
...
$(document).ready(function(){
 ...
 <?php
      ...
      {         
          ...
          $sql="select *  from feedback_data where First = '5' or First = '4' or First = '3' and upper(Subname) like '".$sub_name."'";
          $result1 = mysqli_query($conn, $sql);
          $sql="select * from feedback_data  where Second = '5' or Second = '4' or Second = '3' and upper(Subname) like '".$sub_name."'";
          $result2 = mysqli_query($conn, $sql);
          $sql="select * from feedback_data  where Third = '5' or Third = '4' or Third = '3' and upper(Subname) like '".$sub_name."'";
          $result3 = mysqli_query($conn, $sql);
          $sql="select * from feedback_data  where Fourth = '5' or Fourth = '4' or Fourth = '3' and upper(Subname) like '".$sub_name."'";
          $result4 = mysqli_query($conn, $sql);
          $sql="select * from feedback_data  where Fifth = '5' or Fifth = '4' or Fifth = '3' and upper(Subname) like '".$sub_name."'";
          $result5 = mysqli_query($conn, $sql); 
          $sql="select * from feedback_data  where Sixth = '5' or Sixth = '4' or Sixth = '3' and upper(Subname) like '".$sub_name."'";
          $result6 = mysqli_query($conn,$sql);
          $sql="select * from feedback_data  where Seventh = '5' or Seventh = '4' or Seventh = '3' and upper(Subname) like '".$sub_name."'";
